...
class ModelEvaluator:
    ...
    def __init__(self, X_train, X_test, y_train, y_test):
        ...
        try:
            ...
            self.models['XGBRegressor'] = XGBRegressor(random_state=42)
        except ImportError as e:
            if platform.system() == 'Darwin':  # macOS
                print("XGBoost no está disponible. Para instalarlo en macOS:")
                print("1. Instala libomp con Homebrew: brew install libomp")
                print("2. Luego reinstala XGBoost: pip install --force-reinstall xgboost")
            else:
                print("XGBoost no está disponible:", str(e))
    ...
    def _get_param_grids_genetic(self):
        ...
        if 'XGBRegressor' in self.models:
